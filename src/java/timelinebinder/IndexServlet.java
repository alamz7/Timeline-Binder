        ...
        if (request.getParameter("btnSearch") != null) 
        {
           String searchKeyword = request.getParameter("keyword");
            ...
            if(!"".equals(searchKeyword))
            {
                ...
                _concept = _controller.processKeyword(searchKeyword);
                
                if(_concept != null)
                {
                    request.setAttribute("concept", _concept);
                    getServletConfig().getServletContext().getRequestDispatcher("/player.jsp").forward(request,response);
                }
                else
                {
