    ...
    public String getTrackURL(Method method) throws UnsupportedEncodingException {
        ...
        switch (method) {
            case Google:
                ...
                if (Notification.DEBUG) System.out.println("(DEBUG) Track URL: " + s);
                return s;
            case YouTubeLegacy:
                ...
                if (Notification.DEBUG) System.out.println("(DEBUG) Track URL (Legacy): " + s);
                return s;
            case YouTubeSignature:        
                ...
                {
                    s += "&kind=asr";
                    if (Notification.DEBUG) System.out.println("(DEBUG) Track ASR URL (Signature): " + s);
                }
                else
                {
                    if (Notification.DEBUG) System.out.println("(DEBUG) Track URL (Signature): " + s);
                }
    ...
    public String getTargetURL(Method method, NetSubtitle source) throws UnsupportedEncodingException {
        ...
        switch (method) {
            ...
            case YouTubeLegacy:
                ...
                if (Notification.DEBUG) System.out.println("(DEBUG) Target URL (Legacy): " + s);
                return s;
            case YouTubeSignature:
                /* *** IMPORTANT NOTE ***
                 * Targets DO NOT use its parent video to generate the URL.
                ...
                */
                ...
                {
                    s += "&kind=asr";
                    if (Notification.DEBUG) System.out.println("(DEBUG) Target ASR URL (Signature): " + s);
                }
                else
                {
                    if (Notification.DEBUG) System.out.println("(DEBUG) Target URL (Signature): " + s);
                }
    ...
    public static String getListURL(Method method, HashMap<String, String> params) throws UnsupportedEncodingException {
        ...
        switch (method) {
            case Google:
                ...
                if (Notification.DEBUG) System.out.println("(DEBUG) List URL: " + s);
                return s;
            ...
            case YouTubeLegacy: // Subtitles and translations (from v0.6) using "legacy method"
                ...
                if (Notification.DEBUG) System.out.println("(DEBUG) Tracks with targets list URL (Legacy): " + s);
                return s;
            case YouTubeSignature:
            ...
            if (Notification.DEBUG) System.out.println("(DEBUG) ASR/tracks with targets list URL (Signature): " + s);
            return s;
        }
        return null;
    }
